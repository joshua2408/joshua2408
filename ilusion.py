...
def generar_ticket_html(titulo, id_doc, items, total, cliente=None):
    ...
    # 1. Generamos primero las filas de la tabla de forma independiente 📊
    filas_productos = []
    for it in items:
        fila = f"""
        <tr>
    ...
    tabla_items_html = "".join(filas_productos)

    # 2. Ahora construimos el ticket e insertamos la tabla ya procesada 🎫
    return f"""
    <div style="
